...
function Product() {
  ...
  const { data, isLoading } = useProduct(pageNum, search);
  ...
  return (
    <>
      <ul className="grid place-items-center  grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-20 md:gap-5 ml-5 mt-14">
